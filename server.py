...
def recieve_message(client_socket):  #from a client socket
    '''recieve an incoming message from a specific slient and froward the message to be broadcasted'''
    while True:
        try:
...
def connect_client():
    ...
    while True:
        ...
        print(f"Conncted with {client_address}...")

        #Send a NAME flaf to prompt the client for their name
        ...
        client_socket.send(f"{client_name}, you have just joined!" .encode(ENCODER))   #Individual
